...
<template>
    ...
    <el-header>
        <div class="top-bar">
                <el-button class="link-btn" @click="setCurrentView('Learn')">
                    <div>学习</div>
                </el-button>
        <div class="sep1"></div>
                <el-button class="link-btn" @click="setCurrentView('Test')">
                    <div>测试</div>
                </el-button>
        <div class="sep"></div>
                <img class="logo" src="../components/pics/logo1.png" alt="Logo" />
        <div class="sep"></div>
                <el-button class="link-btn" @click="setCurrentView('MissionIni')">
                    <div>任务</div>
                </el-button>
        <div class="sep1" id="login"></div>
                <el-button class="link-btn" id="login" @click="setCurrentView('Personal')">
                    <div>我的</div>
                </el-button>
        </div>
    </el-header>
    ...
    <el-main>
        <div class="mainpage">
            <component :is="currentViewMap[currentView]" />
        </div>
    </el-main>
    <!--尾部-->
    <el-footer>
        <div>
            <ul class="example-2">
                ...
                <li class="icon-content">
                    <a href="https://www.bilibili.com/" aria-label="Bilibili" data-social="bilibili">
                        <div class="filled"></div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-instagram" viewBox="0 0 24 24" xml:space="preserve">
                            <path
